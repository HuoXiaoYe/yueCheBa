...
// 目的地
// 希望人数
class ConfirmBookList extends StatefulWidget {
  final Map info;
  ConfirmBookList(this.info);
  @override
  _ConfirmBookListState createState() => _ConfirmBookListState();
}
        ...
        child: Column(
          children: <Widget>[
            Card(
              child: Column(
                children: <Widget>[
                  info["time"] == null || info["time"] == ""
                      ? Container()
                      : _item("时间：", info["time"]),
                  info["startAddr"] == null || info["startAddr"] == ""
                      ? Container()
                      : _item("出发地：", info["startAddr"]),
                  info["endAddr"] == null || info["endAddr"] == ""
                      ? Container()
                      : _item("目的地：", info["endAddr"]),
                  info["number"] == null || info["number"] == ""
                      ? Container()
                      : _item("人数：", info["number"]),
                  Container(
